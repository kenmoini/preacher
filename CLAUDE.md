...
This command **requires** the project directory as an argument via `/Users/kenmoini/Development/preacher`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/kenmoini/Development/preacher/.autoforge/prompts/app_spec.txt` and `/Users/kenmoini/Development/preacher/.autoforge/prompts/initializer_prompt.md`

If `/Users/kenmoini/Development/preacher` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/kenmoini/Development/preacher/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/kenmoini/Development/preacher/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/Users/kenmoini/Development/preacher/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/Users/kenmoini/Development/preacher/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/kenmoini/Development/preacher/.autoforge/prompts/`!
>
> **Files created:**
> - `/Users/kenmoini/Development/preacher/.autoforge/prompts/app_spec.txt`
> - `/Users/kenmoini/Development/preacher/.autoforge/prompts/initializer_prompt.md`
>
